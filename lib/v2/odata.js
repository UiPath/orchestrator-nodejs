...
custom.putAsset = function (orchestrator) {
    return function (id, data, callback) {
        orchestrator.put(orchestrator._options.path + format('/odata/Assets(%i)', id), data, callback);
    };
};
...
custom.deleteAsset = function (orchestrator) {
    return function (id, callback) {
        orchestrator.delete(orchestrator._options.path + format('/odata/Assets(%i)', id), callback);
    };
};
...
custom.getEnvironment = function (orchestrator) {
    return function (id, query, callback) {
        orchestrator.get(
            orchestrator._options.path + format('/odata/Environments(%i)', id),
            query,
            callback
        );
    };
...
custom.getRobotsForEnvironment = function (orchestrator) {
    return function (key, query, callback) {
        orchestrator.get(
            orchestrator._options.path + format('/odata/Environments/UiPath.Server.Configuration.OData.GetRobotsForEnvironment(key=%i)', key),
            query,
            callback
        );
    };
...
custom.getRobotIdsForEnvironment = function (orchestrator) {
    return function (key, query, callback) {
        orchestrator.get(
            orchestrator._options.path + format('/odata/Environments/UiPath.Server.Configuration.OData.GetRobotIdsForEnvironment(key=%i)', key),
            query,
            callback
        );
    };
...
custom.postEnvironmentAddRobot = function (orchestrator) {
    return function (id, data, callback) {
        orchestrator.post(
            orchestrator._options.path + format('/odata/Environments(%i)/UiPath.Server.Configuration.OData.AddRobot', id),
            data,
            callback
        );
    };
...
custom.postEnvironmentRemoveRobot = function (orchestrator) {
    return function (id, data, callback) {
        orchestrator.post(
            orchestrator._options.path + format('/odata/Environments(%i)/UiPath.Server.Configuration.OData.RemoveRobot', id),
            data,
            callback
        );
    };
...
custom.postEnvironmentSetRobots = function (orchestrator) {
    return function (id, data, callback) {
        orchestrator.post(
            orchestrator._options.path + format('/odata/Environments(%i)/UiPath.Server.Configuration.OData.SetRobots', id),
            data,
            callback
        );
    };
...
custom.getJob = function (orchestrator) {
    return function (id, query, callback) {
        orchestrator.get(
            orchestrator._options.path + format('/odata/Jobs(%i)', id),
            query,
            callback
        );
    };
...
custom.postStopJob = function (orchestrator) {
    return function (id, data, callback) {
        orchestrator.post(
            orchestrator._options.path + format('/odata/Jobs(%i)/UiPath.Server.Configuration.OData.StopJob', id),
            data,
            callback
        );
    };
...
custom.deleteProcess = function (orchestrator) {
    return function (id, callback) {
        orchestrator.delete(
            orchestrator._options.path + format('/odata/Processes(\'%i\')', id),
            callback
        );
    };
};
...
custom.getProcessVersions = function (orchestrator) {
    return function (processId, query, callback) {
        orchestrator.get(
            orchestrator._options.path + format('/odata/Processes/UiPath.Server.Configuration.OData.GetProcessVersions(processId=\'%i\')', processId),
            query,
            callback
        );
    };
...
custom.getProcessSchedule = function (orchestrator) {
    return function (id, query, callback) {
        orchestrator.get(
            orchestrator._options.path + format('/odata/ProcessSchedules(%i)', id),
            query,
            callback
        );
    };
...
custom.getRobotIdsForSchedule = function (orchestrator) {
    return function (key, query, callback) {
        orchestrator.get(
            orchestrator._options.path + format('/odata/ProcessSchedules/UiPath.Server.Configuration.OData.GetRobotIdsForSchedule(key=%i)', key),
            query,
            callback
        );
    };
...
custom.getQueueDefinition = function (orchestrator) {
    return function (id, query, callback) {
        orchestrator.get(
            orchestrator._options.path + format('/odata/QueueDefinitions(%i)', id),
            query,
            callback
        );
    };
...
custom.getQueueDefinitionReports = function (orchestrator) {
    return function (id, query, callback) {
        orchestrator.get(
            orchestrator._options.path + format('/odata/QueueDefinitions(%i)/UiPathODataSvc.Reports()', id),
            query,
            callback
        );
    };
...
custom.getQueueItemComment = function (orchestrator) {
    return function (id, query, callback) {
        orchestrator.get(
            orchestrator._options.path + format('/odata/QueueItemComments(%i)', id),
            query,
            callback
        );
    };
...
custom.getQueueItemEvent = function (orchestrator) {
    return function (id, query, callback) {
        orchestrator.get(
            orchestrator._options.path + format('/odata/QueueItemEvents(%i)', id),
            query,
            callback
        );
    };
...
custom.getQueueItem = function (orchestrator) {
    return function (id, query, callback) {
        orchestrator.get(
            orchestrator._options.path + format('/odata/QueueItems(%i)', id),
            query,
            callback
        );
    };
...
custom.getItemProcessingHistory = function (orchestrator) {
    return function (id, query, callback) {
        orchestrator.get(
            orchestrator._options.path + format('/odata/QueueItems(%i)/UiPathODataSvc.GetItemProcessingHistory()', id),
            query,
            callback
        );
    };
...
custom.postSetTransactionProgress = function (orchestrator) {
    return function (id, data, callback) {
        orchestrator.post(
            orchestrator._options.path + format('/odata/QueueItems(%i)/UiPathODataSvc.SetTransactionProgress', id),
            data,
            callback
        );
    };
...
custom.getQueueProcessingRecord = function (orchestrator) {
    return function (id, query, callback) {
        orchestrator.get(
            orchestrator._options.path + format('/odata/QueueProcessingRecords(%i)', id),
            query,
            callback
        );
    };
...
custom.getQueue = function (orchestrator) {
    return function (id, query, callback) {
        orchestrator.get(
            orchestrator._options.path + format('/odata/Queues(%i)', id),
            query,
            callback
        );
    };
...
custom.postSetTransactionResult = function (orchestrator) {
    return function (id, data, callback) {
        orchestrator.post(
            orchestrator._options.path + format('/odata/Queues(%i)/UiPathODataSvc.SetTransactionResult', id),
            data,
            callback
        );
    };
...
custom.getRelease = function (orchestrator) {
    return function (id, query, callback) {
        orchestrator.get(
            orchestrator._options.path + format('/odata/Releases(%i)', id),
            query,
            callback
        );
    };
...
custom.postUpdateReleaseToSpecificPackageVersion = function (orchestrator) {
    return function (id, data, callback) {
        orchestrator.post(
            orchestrator._options.path + format('/odata/Releases(%i)/UiPath.Server.Configuration.OData.UpdateToSpecificPackageVersion', id),
            data,
            callback
        );
    };
...
custom.postUpdateReleaseToLatestPackageVersion = function (orchestrator) {
    return function (id, data, callback) {
        orchestrator.post(
            orchestrator._options.path + format('/odata/Releases(%i)/UiPath.Server.Configuration.OData.UpdateToLatestPackageVersion', id),
            data,
            callback
        );
    };
...
custom.postRollbackToPreviousReleaseVersion = function (orchestrator) {
    return function (id, data, callback) {
        orchestrator.post(
            orchestrator._options.path + format('/odata/Releases(%i)/UiPath.Server.Configuration.OData.RollbackToPreviousReleaseVersion', id),
            data,
            callback
        );
    };
...
custom.getRobot = function (orchestrator) {
    return function (id, query, callback) {
        orchestrator.get(
            orchestrator._options.path + format('/odata/Robots(%i)', id),
            query,
            callback
        );
    };
...
custom.putRole = function (orchestrator) {
    return function (id, data, callback) {
        orchestrator.put(
            orchestrator._options.path + format('/odata/Roles(%i)', id),
            data,
            callback
        );
    };
...
custom.getUsersForRole = function (orchestrator) {
    return function (key, query, callback) {
        orchestrator.get(
            orchestrator._options.path + format('/odata/Roles/UiPath.Server.Configuration.OData.GetUsersForRole(key=%i)', key),
            query,
            callback
        );
    };
...
custom.getUserIdsForRole = function (orchestrator) {
    return function (key, query, callback) {
        orchestrator.get(
            orchestrator._options.path + format('/odata/Roles/UiPath.Server.Configuration.OData.GetUserIdsForRole(key=%i)', key),
            query,
            callback
        );
    };
...
custom.postSetRoleUsers = function (orchestrator) {
    return function (id, data, callback) {
        orchestrator.post(
            orchestrator._options.path + format('/odata/Roles(%i)/UiPath.Server.Configuration.OData.SetUsers', id),
            data,
            callback
        );
    };
...
custom.getSetting = function (orchestrator) {
    return function (idOrKey, query, callback) {
        orchestrator.get(
            orchestrator._options.path + format('/odata/Settings(%s)', idOrKey),
            query,
            callback
        );
    };
...
custom.putSetting = function (orchestrator) {
    return function (id, data, callback) {
        orchestrator.put(
            orchestrator._options.path + format('/odata/Settings(%i)', id),
            data,
            callback
        );
    };
...
custom.getExecutionSettingsConfiguration = function (orchestrator) {
    return function (scope, query, callback) {
        orchestrator.get(
            orchestrator._options.path + format('/odata/Settings/UiPath.Server.Configuration.OData.GetExecutionSettingsConfiguration(scope=%i)', scope),
            query,
            callback
        );
    };
...
custom.getTenant = function (orchestrator) {
    return function (id, query, callback) {
        orchestrator.get(
            orchestrator._options.path + format('/odata/Tenants(%i)', id),
            query,
            callback
        );
    };
...
custom.getUserLoginAttempts = function (orchestrator) {
    return function (id, query, callback) {
        orchestrator.get(
            orchestrator._options.path + format('/odata/UserLoginAttempts(%i)', id),
            query,
            callback
        );
    };
...
custom.getUser = function (orchestrator) {
    return function (id, query, callback) {
        orchestrator.get(
            orchestrator._options.path + format('/odata/Users(%i)', id),
            query,
            callback
        );
    };
...
custom.postToggleUserRole = function (orchestrator) {
    return function (id, data, callback) {
        orchestrator.post(
            orchestrator._options.path + format('/odata/Users(%i)/UiPath.Server.Configuration.OData.ToggleRole', id),
            data,
            callback
        );
    };
...
custom.postChangeUserPassword = function (orchestrator) {
    return function (id, data, callback) {
        orchestrator.post(
            orchestrator._options.path + format('/odata/Users(%i)/UiPath.Server.Configuration.OData.ChangePassword', id),
            data,
            callback
        );
    };
...
custom.postSetUserActive = function (orchestrator) {
    return function (id, data, callback) {
        orchestrator.post(
            orchestrator._options.path + format('/odata/Users(%i)/UiPath.Server.Configuration.OData.SetActive', id),
            data,
            callback
        );
    };
