...
custom.putAsset = function (orchestrator) {
    return function (id, data, callback) {
        orchestrator.put(format('Assets(%i)', id), data, callback);
    };
};
...
custom.deleteAsset = function (orchestrator) {
    return function (id, callback) {
        orchestrator.delete(format('Assets(%i)', id), callback);
    };
};
 ...
 * @name getRobotAsset
 * @memberOf V2RestGroup.odata
 * @type {function(robotId: number, assetName: string, query: Object, OrchestratorRestHelperCallback)}
 */
...
custom.getRobotAsset = function (orchestrator) {
    return function (robotId, assetName, query, callback) {
        orchestrator.get(
            format(
                'Assets/UiPath.Server.Configuration.OData.GetRobotAsset(robotId=\'%i\',assetName=\'%s\')',
                robotId,
                assetName
            ),
            query,
...
custom.getAuditLogDetails = function (orchestrator) {
    return function (auditLogId, query, callback) {
        orchestrator.get(
            format(
                'AuditLogs/UiPath.Server.Configuration.OData.GetAuditLogDetails(auditLogId=%i)',
                auditLogId
            ),
            query,
            callback
...
custom.getRobotsForEnvironment = function (orchestrator) {
    return function (key, query, callback) {
        orchestrator.get(
            format('Environments/UiPath.Server.Configuration.OData.GetRobotsForEnvironment(key=%i)', key),
            query,
            callback
        );
    };
...
custom.getRobotIdsForEnvironment = function (orchestrator) {
    return function (key, query, callback) {
        orchestrator.get(
            format('Environments/UiPath.Server.Configuration.OData.GetRobotIdsForEnvironment(key=%i)', key),
            query,
            callback
        );
    };
...
custom.postEnvironmentAddRobot = function (orchestrator) {
    return function (id, data, callback) {
        orchestrator.post(
            format('Environments(%i)/UiPath.Server.Configuration.OData.AddRobot', id),
            data,
            callback
        );
    };
...
custom.postEnvironmentRemoveRobot = function (orchestrator) {
    return function (id, data, callback) {
        orchestrator.post(
            format('Environments(%i)/UiPath.Server.Configuration.OData.RemoveRobot', id),
            data,
            callback
        );
    };
...
custom.postEnvironmentSetRobots = function (orchestrator) {
    return function (id, data, callback) {
        orchestrator.post(
            format('Environments(%i)/UiPath.Server.Configuration.OData.SetRobots', id),
            data,
            callback
        );
    };
...
custom.postStopJob = function (orchestrator) {
    return function (id, data, callback) {
        orchestrator.post(
            format('Jobs(%i)/UiPath.Server.Configuration.OData.StopJob', id),
            data,
            callback
        );
    };
...
custom.getProcessVersions = function (orchestrator) {
    return function (processId, query, callback) {
        orchestrator.get(
            format('Processes/UiPath.Server.Configuration.OData.GetProcessVersions(processId=\'%i\')', processId),
            query,
            callback
        );
    };
...
custom.getRobotIdsForSchedule = function (orchestrator) {
    return function (key, query, callback) {
        orchestrator.get(
            format('ProcessSchedules/UiPath.Server.Configuration.OData.GetRobotIdsForSchedule(key=%i)', key),
            query,
            callback
        );
    };
...
custom.getQueueDefinitionReports = function (orchestrator) {
    return function (id, query, callback) {
        orchestrator.get(
            format('QueueDefinitions(%i)/UiPathODataSvc.Reports()', id),
            query,
            callback
        );
    };
...
custom.getQueueItemCommentsHistory = function (orchestrator) {
    return function (queueItemId, query, callback) {
        orchestrator.get(
            format(
                'QueueItemComments/UiPath.Server.Configuration.OData.GetQueueItemCommentsHistory(queueItemId=%i)',
                queueItemId
            ),
            query,
            callback
...
custom.getQueueItemEventsHistory = function (orchestrator) {
    return function (queueItemId, query, callback) {
        orchestrator.get(
            format(
                'QueueItemEvents/UiPath.Server.Configuration.OData.GetQueueItemEventsHistory(queueItemId=%i)',
                queueItemId
            ),
            query,
            callback
...
custom.getItemProcessingHistory = function (orchestrator) {
    return function (id, query, callback) {
        orchestrator.get(
            format('QueueItems(%i)/UiPathODataSvc.GetItemProcessingHistory()', id),
            query,
            callback
        );
    };
...
custom.postSetTransactionProgress = function (orchestrator) {
    return function (id, data, callback) {
        orchestrator.post(
            format('QueueItems(%i)/UiPathODataSvc.SetTransactionProgress', id),
            data,
            callback
        );
    };
...
custom.getQueueProcessingRecord = function (orchestrator) {
    return function (id, query, callback) {
        orchestrator.get(
            format('QueueProcessingRecords(%i)', id),
            query,
            callback
        );
    };
...
custom.getLastDaysProcessingRecords = function (orchestrator) {
    return function (queueDefinitionId, daysNo, query, callback) {
        orchestrator.get(
            format(
                'QueueProcessingRecords/UiPathODataSvc.RetrieveLastDaysProcessingRecords(daysNo=%i,queueDefinitionId=%i)',
                daysNo,
                queueDefinitionId
            ),
            query,
...
custom.postSetTransactionResult = function (orchestrator) {
    return function (id, data, callback) {
        orchestrator.post(
            format('Queues(%i)/UiPathODataSvc.SetTransactionResult', id),
            data,
            callback
        );
    };
...
custom.postUpdateReleaseToSpecificPackageVersion = function (orchestrator) {
    return function (id, data, callback) {
        orchestrator.post(
            format('Releases(%i)/UiPath.Server.Configuration.OData.UpdateToSpecificPackageVersion', id),
            data,
            callback
        );
    };
...
custom.postUpdateReleaseToLatestPackageVersion = function (orchestrator) {
    return function (id, data, callback) {
        orchestrator.post(
            format('Releases(%i)/UiPath.Server.Configuration.OData.UpdateToLatestPackageVersion', id),
            data,
            callback
        );
    };
...
custom.postRollbackToPreviousReleaseVersion = function (orchestrator) {
    return function (id, data, callback) {
        orchestrator.post(
            format('Releases(%i)/UiPath.Server.Configuration.OData.RollbackToPreviousReleaseVersion', id),
            data,
            callback
        );
    };
...
custom.getUsersForRole = function (orchestrator) {
    return function (key, query, callback) {
        orchestrator.get(
            format('Roles/UiPath.Server.Configuration.OData.GetUsersForRole(key=%i)', key),
            query,
            callback
        );
    };
...
custom.getUserIdsForRole = function (orchestrator) {
    return function (key, query, callback) {
        orchestrator.get(
            format('Roles/UiPath.Server.Configuration.OData.GetUserIdsForRole(key=%i)', key),
            query,
            callback
        );
    };
...
custom.postSetRoleUsers = function (orchestrator) {
    return function (id, data, callback) {
        orchestrator.post(
            format('Roles(%i)/UiPath.Server.Configuration.OData.SetUsers', id),
            data,
            callback
        );
    };
...
custom.getExecutionSettingsConfiguration = function (orchestrator) {
    return function (scope, query, callback) {
        orchestrator.get(
            format('Settings/UiPath.Server.Configuration.OData.GetExecutionSettingsConfiguration(scope=%i)', scope),
            query,
            callback
        );
    };
...
custom.postToggleUserRole = function (orchestrator) {
    return function (id, data, callback) {
        orchestrator.post(
            format('Users(%i)/UiPath.Server.Configuration.OData.ToggleRole', id),
            data,
            callback
        );
    };
...
custom.postChangeUserPassword = function (orchestrator) {
    return function (id, data, callback) {
        orchestrator.post(
            format('Users(%i)/UiPath.Server.Configuration.OData.ChangePassword', id),
            data,
            callback
        );
    };
...
custom.postSetUserActive = function (orchestrator) {
    return function (id, data, callback) {
        orchestrator.post(
            format('Users(%i)/UiPath.Server.Configuration.OData.SetActive', id),
            data,
            callback
        );
    };
