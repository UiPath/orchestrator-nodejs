...
function Orchestrator(options) {
    ...
    /** @type {V2RestGroup} */
    this.v2 = v2.v2Factory(this, this._options.path);
    /**
...
Orchestrator.prototype._login = function (callback) {
    ...
    requestOptions = {
        ...
        port: options.port,
        path: path.join(options.path, '/api/Account'),
        agent: this._agent
    };
    loginRequestData = {
 ...
 * @returns {string}
 */
Orchestrator.prototype._formatEndpoint = function (format, values) {
    /** @type {string} */
    var _format = arguments[0];
    /** @type {Array} */
    var _values = Array.prototype.slice.call(arguments, 1);

    return path.join(this._options.path, util.format.apply(_format, _values));
};
